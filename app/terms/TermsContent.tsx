  ...
  en: {
    ...
    intro: (
      <>
        ...
        EN26, and others) has its own terms of service on its own domain.
      </>
    ),
    ...
    s5_p1:
      "This site links to products and services we've built (Buzomed, Vivo, EN26, SplitOrNot, Expiration Date, and others), each hosted on its own domain with its own terms and privacy policy. We're not responsible for the content, terms, or data practices of any third-party site we link to, including those.",
  ...
  ro: {
    ...
    intro: (
      <>
        ...
        exclusiv site-ul studioului — fiecare produs pe care îl construim (Buzomed, Vivo, EN26 și
    ...
    s5_p1:
      "Acest site face trimitere către produse și servicii pe care le-am construit (Buzomed, Vivo, EN26, SplitOrNot, Expiration Date și altele), fiecare găzduit pe propriul domeniu, cu proprii termeni și politică de confidențialitate. Nu suntem responsabili pentru conținutul, termenii sau practicile de date ale niciunui site terț către care facem trimitere, inclusiv ale acestora.",
